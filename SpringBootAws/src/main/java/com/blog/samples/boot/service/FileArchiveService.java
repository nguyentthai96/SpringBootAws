...
public class FileArchiveService {
    ...
    private AmazonS3Client s3Client = new AmazonS3Client(new AWSCredentials() {
        ...
        public String getAWSAccessKeyId() {
            return "AKIAJVJDFZ3RBKU4XFBQ";
        }

        @Override
        public String getAWSSecretKey() {
            return "W0k8Q4vWDWSVyFkaOR1TMrBPRPaKPqb34gbLuFZA";
        }
    });

    private static final String S3_BUCKET_NAME = "s3groupeleven";
    ...
    public CustomerImage saveFileToS3(MultipartFile multipartFile) throws FileArchiveServiceException {
        ...
        try {
            ...
            System.out.println("S3 Upload " + signedUrl.toString());
